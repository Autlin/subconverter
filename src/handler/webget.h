...
struct FetchArgument
{
    ...
    const bool allow_authorization = false;
};
...
void flushCache();
int webPost(const std::string &url, const std::string &data, const std::string &proxy, const string_icase_map &request_headers, std::string *retData, bool allow_authorization = false);
int webPatch(const std::string &url, const std::string &data, const std::string &proxy, const string_icase_map &request_headers, std::string *retData, bool allow_authorization = false);
